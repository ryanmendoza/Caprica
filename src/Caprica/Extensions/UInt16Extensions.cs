...
{
    /// <summary>
    ///     Defines an static class which contains extension methods of <see cref="T:System.UInt16" />.
    /// </summary>
    public static class UInt16Extensions
    {
        ...
        /// </returns>
        public static DateTime FromUnixTimestampToDateTime(this ushort instance)
        {
