...
{
    /// <summary>
    ///     Defines an static class which contains extension methods of <see cref="T:System.Int32" />.
    /// </summary>
    public static class Int32Extensions
    {
        ...
        /// </returns>
        public static DateTime FromUnixTimestampToDateTime(this int instance)
        {
