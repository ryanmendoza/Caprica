...
namespace Caprica.Infrastructure.Rules.Expressions
{
    /// <inheritdoc />
    /// <summary>
    ///     Evaluates whether either of two expressions are <see langword="true" />.
    /// </summary>
    public class ConditionalOrExpression : BooleanExpression
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="T:Caprica.Infrastructure.Rules.Expressions.ConditionalOrExpression" /> class.
        /// </summary>
        /// <param name="left">
        ...
        /// </returns>
        /// <remarks>
        ///     <see cref="T:Caprica.Infrastructure.Rules.Expressions.ConditionalOrExpression" /> will always
